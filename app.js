...
bot.on('message', msg => {
    ...
    } else if (msg.content.includes('boa noite') || msg.content.includes('Boa noite')) {
        attachment = new Attachment('https://i.ytimg.com/vi/kUaTEFCBm5s/maxresdefault.jpg');
        msg.reply('Flw, também to indo...', attachment);
